  ...
  function setSchedule(games){
      ...
      games.forEach(game => {
       ...
       var fecha= game.scheduled.substring(0,game.scheduled.indexOf('T')).split('-');
          ...
          +'<img class "d-inline-block" width=15% height=10% src="http://loodibee.com/wp-content/uploads/nfl-'+local+'-team-logo-2-350x350.png">'
          ...
          +'<img class "d-inline-block" width=15% height=10% src="http://loodibee.com/wp-content/uploads/nfl-'+visitante+'-team-logo-2-350x350.png"><p class="d-inline-block card-text"><strong>'+ game.away.name+'</strong></p>'
