  ...
  conferences.forEach(conference => {
    ...
    conference.divisions.forEach(divisions=>{
      divisions.teams.forEach(team=>{
        ...
        let linea= '<tr><th scope="row"><img src="https://loodibee.com/wp-content/uploads/nfl-'+city+'-'+name+'-team-logo-2-350x350.png" width=100px height=100px alt="'+team.name+' logo">'+team.market+' '+team.name+'</th><td>'
